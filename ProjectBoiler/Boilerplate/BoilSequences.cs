...
namespace Boilerplate
{
    public class BoilSequences
    {
        ...
        public static List<long> PrimesSequenceUpTo(long upperlimit)
        {
            ...
            if (upperlimit < 30000)
            {
                pattern = new long[] { 4, 2, 4, 2, 4, 6, 2, 6 };
                basePrime = 7;
            }
            else if (upperlimit < 30000000)
            {
                primes.Add(7);
                pattern = new long[] { 2, 4, 2, 4, 6, 2, 6, 4, 2, 4, 6, 6, 2, 6, 4, 2, 6, 4, 6, 8, 4, 2, 4, 2, 4, 8, 6, 4, 6, 2, 4, 6, 2, 6, 6, 4, 2, 4, 6, 2, 6, 4, 2, 4, 2, 10, 2, 10 };
                basePrime = 11;
            }
            else
            {
        ...
        {
            var upperlimit = (long)(nth * (Math.Log(nth) + Math.Log(Math.Log(nth))));
