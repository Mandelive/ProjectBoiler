    ...
    public class BoilMathFunctions
    {
        ...
        public static long DivisorSigma0(long n)
        {
            ...
            while (n > 1)
            {
                ...
                basePrime += primeWF13[patternIndex];
            }
        ...
        public static bool IsPrimeWheelFactorization(long n)
        {
            ...
            for (long sp = baseSemiPrime; sp <= nsqrt; sp += primeWF13[patternIndex])
            {
                if (n % sp == 0)
                {
                    return false;
        ...
        public static bool IsPrimeHybrid(long n)
        {
            ...
            else if (n % 2 == 0 || n % 3 == 0 || n % 5 == 0 || n % 7 == 0 || n % 11 == 0 || n % 13 == 0 || n % 17 == 0 || n % 19 == 0 || n % 23 == 0 || n % 29 == 0 || n % 31 == 0 || n % 37 == 0
        ...
        public static long NextPrime(long n)
        {
            ...
            var nextPrime = (n % 2 == 0 ? n + 1 : n + 2);

            while (!BoilMathFunctions.IsPrimeHybrid(nextPrime))
            {
                nextPrime += 2;
            }
        ...
        public static long PreviousPrime(long n)
        {
            ...
            var prevPrime = (n % 2 == 0 ? n - 1 : n - 2);

            while (!BoilMathFunctions.IsPrimeHybrid(prevPrime))
            {
                prevPrime -= 2;
            }
